...
const QUESTIONS = [
  { q: "Champagner oder Craft-Bier — was bringt dich schneller dazu, die Hüllen … äh, Hemmungen fallen zu lassen? 😏",
    a: ["Champagner, ich bin klassisch fein 🥂", "Bier, ich bin bodenständig 🍺", "Beides, ich bin schnell zu haben 😏", "Nüchtern bin ich mutiger, als du denkst"] },
  { q: "Isst du ein Date wie ein Menü — Vorspeise, Hauptgang, Nachspiel? Oder springst du direkt zum Nachspiel?",
    a: ["Ich genieße jeden Gang in Ruhe", "Ich spring gern direkt zum Nachspiel 😉", "Ich teile lieber einen Teller — und mehr", "Ich bestelle einfach alles"] },
  { q: "Dein Vorspiel beim Kennenlernen: ausgiebig zelebriert — oder lieber schnell zur Sache?",
    a: ["Ich zelebriere jedes Detail", "Ich komm lieber schnell zur Sache 😏", "Kommt auf mein Gegenüber an", "Ich lass mich gern verführen"] },
  { q: "Kerzenlicht-Dinner oder Lagerfeuer unterm Sternenhimmel — wobei verlierst du eher die Kontrolle?",
    a: ["Beim Kerzenlicht, ganz elegant", "Am Lagerfeuer, da werd ich wild 🔥", "Bei beidem, wenn die Chemie stimmt", "Kontrolle verlier ich nicht so leicht"] },
  { q: "Erstes Date: Gentleman-Modus — oder gleich ran ans Eingemachte?",
    a: ["Gentleman-Modus, ich nehm mir Zeit", "Ran ans Eingemachte, ich weiß was ich will 😏", "Kommt drauf an, wer mich fragt", "Ich lass mich einfach überraschen"] },
  { q: "Anklopfen und höflich warten — oder gleich reinkommen? Wie bist du so als Gast?",
    a: ["Ich klopfe artig an und warte", "Ich komm einfach rein, wenn die Tür offen ist 😉", "Ich frag vorher lieber nochmal nach", "Kommt drauf an, wie einladend es aussieht"] },
  { q: "Ein Gute-Nacht-Kuss an der Tür — reicht dir das, oder klingelst du sicherheitshalber noch mal?",
    a: ["Der Kuss reicht mir völlig", "Ich klingel definitiv noch mal 😉", "Kommt drauf an, wie das Date lief", "Ich küss nicht beim ersten Date"] },
  { q: "Absacker bei dir — oder bei mir?",
    a: ["Weder noch, ich mag's gesittet", "Bei mir, ich hab den besseren Whiskey 😏", "Bei dir, ich bin neugierig", "Kommt drauf an, wie der Abend war"] },
  { q: "Bett oder Sofa — wo lässt du dich lieber überraschen?",
    a: ["Sofa, da bleib ich lieber in Reichweite der Tür", "Bett, ich mag's gemütlich 😉", "Überall, solang's überraschend ist", "Frag mich das nach dem ersten Date nochmal"] },
  { q: "Skala von Kuscheltier bis Feuerwerk — wie explosiv wird die Nacht mit mir?",
