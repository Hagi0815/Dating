...
const QUESTIONS = [
  ...
  { q: "Dein Vorspiel beim Kennenlernen: lange umeinander schleichen — oder direkt Tacheles reden?",
    a: ["Ich schleiche gern lange drum herum", "Ich rede lieber sofort Tacheles 😏", "Kommt auf mein Gegenüber an", "Ich warte, bis der andere den ersten Schritt macht"] },
  { q: "Kerzenlicht-Dinner oder Lagerfeuer unterm Sternenhimmel — wobei wird's bei dir richtig heiß?",
    a: ["Kerzenlicht, ich mag's elegant heiß", "Lagerfeuer, ich mag's wild 🔥", "Beides, Hauptsache es knistert", "Bei mir bleibt's erstmal kühl"] },
  ...
  { q: "Taxi rufen oder doch noch auf einen Absacker bleiben?",
    a: ["Taxi, ich mag's gesittet", "Ein Absacker kann nicht schaden 😉", "Kommt drauf an, wie der Abend war", "Ich lad grundsätzlich niemanden ein am ersten Abend"] },
  { q: "Kalte Füße oder warme Hände — wie schnell wird's bei dir persönlich?",
    a: ["Ich brauch erstmal meine Zeit", "Bei mir geht's schnell warm 😏", "Kommt auf die Chemie an", "Frag mich nochmal beim Date"] },
